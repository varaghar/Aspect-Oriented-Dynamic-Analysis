...
public class ODGInputFormat implements InputFormat {
     ...
     * â€¢ Superfluous white space and separators such as commas can be eliminated. (e.g., â€œM 10 10
     * L 20 20 L 30 20â€� can also be written: â€œM10 10L20 20L30 20â€�
     * â€¢ If the command is repeated multiple times, only the first command is required. (e.g., â€œM 10 10
     * L 20 20 L 30 20â€� can also be expressed as followed â€œM 10 10 L 20 20 30 20â€�
     * â€¢ Floats can be used, therefore the only allowable decimal point is a dot (â€œ.â€�)
     ...
     * â€¢ A â€œ?â€� is used to mark the beginning of a formula name. The result of the element's
     * draw:formula attribute is used as parameter value in this case.
     * â€¢ If â€œ$â€� is preceding a integer value, the value is indexing a draw:modifiers attribute. The
        ...
        while (tt.nextToken() != StreamPosTokenizer.TT_EOF) {
            ...
            switch (command) {
                ...
                case 'C':
                    ...
                    // Draws a cubic BeÌ�zier curve from the current
                ...
                case 'N':
                    ...
                    // paths will be filled by using the â€œeven-oddâ€�
                ...
                case 'U':
                    ...
                    // The same as the â€œTâ€� command, except that a implied moveto
                ...
                case 'B':
                    ...
                    // The same as the â€œAâ€� command, except that a
                ...
                case 'W':
                    ...
                    // The same as the â€œAâ€� command except, that the arc is drawn
                    // clockwise.
                    x1 = nextEnhancedCoordinate(tt, str);
                    y1 = nextEnhancedCoordinate(tt, str);
                    x2 = nextEnhancedCoordinate(tt, str);
                ...
                case 'V':
                    ...
                    // The same as the â€œAâ€� command, except that a implied moveto
                ...
                case 'Q':
                    ...
                    // Draws a quadratic BeÌ�zier curve from the current point
     ...
     * â€¢ matrix(<a> <b> <c> <d> <e> <f>), which specifies a transformation in the form of a
     ...
     * â€¢ scale(<sx> [<sy>]), which specifies a scale operation by sx and sy. If <sy> is not
